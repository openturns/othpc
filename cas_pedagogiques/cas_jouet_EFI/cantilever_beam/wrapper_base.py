...
class OpenTURNSWrapper:
    ...
    def __init__(self, input_dimension, output_dimension, index_col=None):
        ...
        self.results_dir = os.path.join(self.base_dir, "results_" + self.date_tag)
        try: 
    ...
    def _build_subtree(self, X, indexes):
        ...
        for r, i in enumerate(indexes):
            ...
            otct.replace(
                ...
                os.path.join(self.base_dir, 'template/beam_input_template.xml'),
...
# TODO: 
# Manage crashes on a different example
# QUESTION: what is the exact difference between getInputHistory vs. getCacheOutput?
