# -*- coding: utf-8 -*-
#
# othpc documentation build configuration file, created by
...
intersphinx_mapping = {
    "python": ("http://openturns.github.io/openturns/1.24", "openturns-objects.inv")
}
